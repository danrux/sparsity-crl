...
def get_mlp(n_in: int, n_out: int,
            ...
            output_normalization_kwargs=None, act_inf_param=0.2):
    """
    Creates an MLP.
...
class ConvEncoder(torch.nn.Module):
    def __init__(self, input_size=3, output_size=18, output_normalization: Union[None, Literal["bn"], Literal["gn"]] = "bn") -> None:
        super().__init__()
...
class ResNetEnc(torch.nn.Module):
    def __init__(self, backbone, hidden_size = 100,encoding_size=7, output_normalization="bn") -> None:
        super().__init__()
